...
import yoshi from "../img/karts/yoshi.png";
...
function Kart({ kart }) {
  let images = { train, blue, pink, green, waluigi, bullet, daisy, boo, luigi, mario, peach, petey, bowser, parade, wario, dk, birdo, yoshi, RattleBuggy, GooGooBuggy, ParaWing };
  return (
